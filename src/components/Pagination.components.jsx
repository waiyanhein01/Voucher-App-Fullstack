        ...
        {links.map((link) => {
          return (
            <button
              ...
              disabled={!link.url}
              className={`flex items-center justify-center first:rounded-l-lg last:rounded-r-lg border disabled:pointer-events-none disabled:opacity-50 px-4 py-2 text-sm font-medium hover:bg-cyan-800 hover:text-cyan-50 ${link.active ? "bg-cyan-700 text-cyan-50" : "bg-gray-50 text-gray-900"} dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white`}
            >
