...
const RegisterPage = () => {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 flex fle-col min-h-screen justify-center items-center">
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            >
              ...
              <button
                disabled={isSingUp}
                type="submit"
                className="w-full text-white disabled:pointer-events-none disabled:opacity-50 bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
              >
